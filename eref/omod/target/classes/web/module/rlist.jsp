...
<script type='text/javascript' src='https://www.google.com/jsapi'></script>
    <script type='text/javascript'>
      ...
      function drawTable() {
        ...
        data.addRows(4);
        data.setCell(0, 0, 'Sneha Das');
        data.setCell(0, 1, 'Malaria');
        data.setCell(0, 2, '11-11-2011');
        data.setCell(0, 3, '12:10');
        data.setCell(0, 4, 'Thane');
        data.setCell(0, 5, '<a href="http://localhost:8080/openmrs-standalone/module/eref/refPatientLink.form">View detais</a>');
        data.setCell(1, 0, 'Nitin Jain');
        data.setCell(1, 1, 'Malaria');
        data.setCell(1, 2, '11-11-2011');
        data.setCell(1, 3, '14:10');
        data.setCell(1, 4, 'Thane');
        data.setCell(1, 5, '<a href="${pageContext.request.contextPath}/module/eref/refPatientLink.form">View detais</a>');
        data.setCell(2, 0, 'Nitya Jha');
        data.setCell(2, 1, 'Pregnancy related');
        data.setCell(2, 2, '12-11-2011');
        data.setCell(2, 3, '11:10');
        data.setCell(2, 4, 'Mulund');
        data.setCell(2, 5, '<a href="h${pageContext.request.contextPath}/module/eref/refPatientLink.form">View detais</a>');
        data.setCell(3, 0, 'Nitin Jain');
        data.setCell(3, 1, 'Dadar');
        data.setCell(3, 2, '14-11-2011');
        data.setCell(3, 3, '23:10');
        data.setCell(3, 4, 'Unknown location');
        data.setCell(3, 5, '<a href="${pageContext.request.contextPath}/module/eref/refPatientLink.form">View detais</a>');
